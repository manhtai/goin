...
func New(l *lexer.Lexer) *Parser {
	...
	// Init and register parser functions for prefixes
	...
	// Init and register parser functions for infixes
...
// Errors return all erors when we parsing program
...
// Helper function to add infix & prefix to corresponding map
